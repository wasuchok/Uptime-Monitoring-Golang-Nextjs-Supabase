...
ระบบมอนิเตอร์สถานะบริการ (uptime / latency) แบบเรียลไทม์ ประกอบด้วย backend ภาษา Go (Fiber) และ frontend Next.js 16 พร้อม WebSocket สำหรับ push สถานะทันทีที่มีการเช็ก

![Dashboard 1](img/1.png)

เพิ่มเติมภาพหน้าจออื่น ๆ:
- ![Dashboard 2](img/2.png)
- ![Dashboard 3](img/3.png)
- ![Dashboard 4](img/4.png)
